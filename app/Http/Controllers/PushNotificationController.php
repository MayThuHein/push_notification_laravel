...
class PushNotificationController extends Controller
{
    ...
    public function bulksend(Request $req){
        ...
        $headers = array (
            'Authorization: key=' . "AAAAfEwz34g:APA91bFuSoUYlUu8LGe5UhGPgVRo_NndOtAz35BlgXXL2mropPlKvK6QGhfAFflXHoF5dIOXQqiCgUgQDZrH0maV88mbKJEstlkfeKzZy6kCcP1nzcVL79ahLHDzmgjBYqT-TxvuqPf6",
